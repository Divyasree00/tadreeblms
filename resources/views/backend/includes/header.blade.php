<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
        ...
        <img class="navbar-brand-full adminlogo" src="../../public/assets/img/logo.png"    alt="Square Logo">
        <img class="navbar-brand-minimized adminlogo" src="../../public/assets/img/logo.png"  alt="Square Logo">
